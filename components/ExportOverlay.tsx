...
export function ExportOverlay({ phase, progress, errorMessage, language, onCancel }: ExportOverlayProps) {
    ...
    <div className="fixed inset-0 z-[99999] flex items-center justify-center bg-black/70 backdrop-blur-sm">
      <div className="nm-card flex w-80 flex-col items-center gap-5 rounded-2xl p-6 text-[var(--nm-text)]">
        ...
        {phase === 'error' && errorMessage && (
          <p className="max-w-full break-words text-center text-xs leading-relaxed text-[var(--nm-text-dim)]">
            {errorMessage}
          </p>
        )}
      </div>
