...
function buildTrainEntries(sourceRoot) {
  ...
  for (const [groupKey, candidates] of groupedCandidates.entries().toSorted()) {
    const chosenCandidate = candidates.toSorted((left, right) => right.score - left.score)[0]
